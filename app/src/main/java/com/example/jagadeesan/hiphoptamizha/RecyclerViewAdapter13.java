...
public class RecyclerViewAdapter13 extends RecyclerView.Adapter<RecyclerViewAdapter13.ViewHolder> {
    private final List<VideoContent.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter13(List<VideoContent.VideoItem> items) {
        mValues = items;
    }
