...
public class RecyclerViewAdapter24 extends RecyclerView.Adapter<RecyclerViewAdapter24.ViewHolder> {
    private final List<VideoContent11.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter24(List<VideoContent11.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent11.VideoItem mItem;
