...
public class RecyclerViewAdapter17 extends RecyclerView.Adapter<RecyclerViewAdapter17.ViewHolder> {
    private final List<VideoContent4.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter17(List<VideoContent4.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent4.VideoItem mItem;
