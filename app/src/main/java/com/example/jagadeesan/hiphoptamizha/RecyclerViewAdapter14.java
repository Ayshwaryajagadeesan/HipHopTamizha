...
public class RecyclerViewAdapter14 extends RecyclerView.Adapter<RecyclerViewAdapter14.ViewHolder> {
    private final List<VideoContent1.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter14(List<VideoContent1.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent1.VideoItem mItem;
