...
public class RecyclerViewAdapter21 extends RecyclerView.Adapter<RecyclerViewAdapter21.ViewHolder> {
    private final List<VideoContent8.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter21(List<VideoContent8.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent8.VideoItem mItem;
