...
public class RecyclerViewAdapter18 extends RecyclerView.Adapter<RecyclerViewAdapter18.ViewHolder> {
    private final List<VideoContent5.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter18(List<VideoContent5.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent5.VideoItem mItem;
