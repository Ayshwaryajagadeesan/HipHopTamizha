...
public class RecyclerViewAdapter23 extends RecyclerView.Adapter<RecyclerViewAdapter23.ViewHolder> {
    private final List<VideoContent10.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter23(List<VideoContent10.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent10.VideoItem mItem;
