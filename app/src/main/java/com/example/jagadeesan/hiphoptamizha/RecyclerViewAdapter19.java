...
public class RecyclerViewAdapter19 extends RecyclerView.Adapter<RecyclerViewAdapter19.ViewHolder> {
    private final List<VideoContent6.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter19(List<VideoContent6.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent6.VideoItem mItem;
