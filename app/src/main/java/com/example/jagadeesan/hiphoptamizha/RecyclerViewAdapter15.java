...
public class RecyclerViewAdapter15 extends RecyclerView.Adapter<RecyclerViewAdapter15.ViewHolder> {
    private final List<VideoContent2.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter15(List<VideoContent2.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent2.VideoItem mItem;
