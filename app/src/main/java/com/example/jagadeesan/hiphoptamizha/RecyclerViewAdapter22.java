...
public class RecyclerViewAdapter22 extends RecyclerView.Adapter<RecyclerViewAdapter22.ViewHolder> {
    private final List<VideoContent9.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter22(List<VideoContent9.VideoItem> items) {
        mValues = items;
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoContent9.VideoItem mItem;
