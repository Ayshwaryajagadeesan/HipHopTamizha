...
public class RecyclerViewAdapter16 extends RecyclerView.Adapter<RecyclerViewAdapter16.ViewHolder> {
    private final List<VideoContent3.VideoItem> mValues;
    private Context context;

    public RecyclerViewAdapter16(List<VideoContent3.VideoItem> items) {
        mValues = items;
    }
